...
//           return value + 'k'; // Append 'k' to each tick value
//         },
//       },
//     },
//   },
...
gradientFill?.addColorStop(0, 'rgba(246, 126, 6, 0.3)'); // Light orange
gradientFill?.addColorStop(1, 'rgba(246, 126, 6, 20)');
          ...
          <div className={styles.frameParent}>
            <div className={styles.frameGroup}>
              ...
              <div className={styles.largeBalance}>
                ...
                <div className={styles.dialogueBox}></div>
              ...
              <section style={{ width: '100%' }}>
                <Bar width={100} height={30} options={options} data={data} />
              </section>
            </div>
                  ...
                  <div className={styles.frameParent1}>
                    ...
                    <div className={styles.frameWrapper2}>
                      <div className={styles.frameParent2}>
                        ...
                        <Doughnut data={piedata} options={doughOptions} />
                      </div>
                    </div>
                  </div>
